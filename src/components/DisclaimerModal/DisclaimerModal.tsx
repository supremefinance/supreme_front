    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the Supreme protocol have made
      ...
      return (
        <div>
          <p>Attention SUPREME Supremeswap LPs</p>
          <p>
            The only Supremeswap pool that is compatible with SUPREME is SUPREME/yCRV
            (Curve yPool tokens)
          </p>
          <p>Providing liquidity for other Supremeswap pools is dangerous</p>
